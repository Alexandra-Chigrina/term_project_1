...
@pytest.mark.parametrize("my_hour, my_minute, expected",
                         [(23, 5, 'Доброй ночи'), (4, 22, 'Доброй ночи'),
                          (7, 43, 'Доброе утро'), (14, 00, 'Добрый день'),
                          (19, 10, 'Добрый вечер')])
...
def test_read_excel(mock_read_excel):
    mock_data = pd.DataFrame({'Дата операции': ['31.12.2021 14:05:47', '20.04.2019 15:01:50'],
                                                'Сумма платежа': ['-160.89', '2100,00']})
